  ...
  <div class="container">
    ...
    <div class="sale">
      <div class="title-sale">
        <img src="../assets/img/title_sale.png" alt="">
      </div>
    ...
    <div class="buy">
      <div class="title-buy">
        <img src="../assets/img/title_buy.png" alt="">
      </div>
      <div class="buy-item">
    ...
    data() {
      return {
        ...
        banner_list: [{
          ...
          {
            url: require('../assets//img/slide_2.png')
          },
          {
            url: require('../assets//img/slide_3.png')
          }
        ]
      }
    },
